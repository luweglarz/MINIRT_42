...
#    Updated: 2021/02/01 17:32:17 by user42           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=   srcs/parser/get_scene_elements.c srcs/parser/get_scene_objects.c srcs/parser/parser.c srcs/utils/lib/lst_func.c srcs/raytracer/light.c \
		...
		srcs/utils/utilsdata.c srcs/utils/vector/vector1.c srcs/utils/vector/vector2.c srcs/parser/parsing_error.c srcs/utils/displayutils.c srcs/raytracer/raytracer.c main.c
